...
id: 0f4c29ce-d5aa-4bc2-a858-32714daa8049
kind: table
order: 2
...
table:
  columns:
  - description: Values for technology.
    name: technology
    type: string
  - description: Values for parameter.
    name: parameter
    type: string
  - description: Values for value.
    name: value
    type: decimal
  - description: Values for unit.
    name: unit
    type: string
  - description: Values for source.
    name: source
    type: string
  - description: Values for further description.
    name: further description
    type: string
  - description: Values for currency_year.
    name: currency_year
    type: decimal
